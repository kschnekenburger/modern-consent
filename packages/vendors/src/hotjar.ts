...
const Hotjar: Vendor<HotjarConfig> = {
  name: 'Hotjar',
  category: 'Analytics',
  description: 'Cartes de chaleur, enregistrements de sessions et sondages pour optimiser l\'expérience utilisateur.',
  ...PURPOSE_ANALYTICS,
  requireConsent: true,
  artifacts: ['_hj', '_hjSession', '_hjSessionUser', '_hjid', '_hjFirstSeen', '_hjAbsoluteSessionInProgress', '_hjIncludedInSessionSample'],
